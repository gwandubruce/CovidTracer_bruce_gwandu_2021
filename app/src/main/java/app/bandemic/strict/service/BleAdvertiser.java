...
public class BleAdvertiser {
    ...
    private final BluetoothLeAdvertiser bluetoothLeAdvertiser;// This class provides a way to perform Bluetooth LE advertise operations, such as starting and stopping advertising.
    private AdvertiseCallback bluetoothAdvertiseCallback; // advertising operation status
    ...
    public void startAdvertising() {
        ...
        AdvertiseData data = new AdvertiseData.Builder()
                ...
                .addServiceUuid(new ParcelUuid(BandemicProfile.BANDEMIC_SERVICE)) // this is the guy being advertised
        ...
        public void onCharacteristicReadRequest(BluetoothDevice device, int requestId, int offset,
            ...
            if (BandemicProfile.HASH_OF_UUID.equals(characteristic.getUuid())) {
                ...
                mBluetoothGattServer.sendResponse(device,
                        ...
                        offset,
                        Arrays.copyOfRange(broadcastData, offset, broadcastData.length)); // broadcastData is data sent to those who would have made a read request
            } else {
